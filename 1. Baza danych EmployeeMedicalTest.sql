...
(9, 'Nyktometria', 50),
(10, 'Cholesterol całkowity', 10),
(11, 'Spirometria', 45),
(12, 'ALT', 35),
(13, 'Bilirubina całkowita', 20),
(14, 'Morfologia', 30),
...
(1, 'Amoniak'),
(2, 'Detergenty, Środki Czystości (Dezynfekujące),'),
(3, 'Dźwiganie'),
(4, 'Freony'),
(5, 'Kierowanie Pojazdem Służbowym Kat. B'),
(6, 'Konkurs Na Kierownika'),
(7, 'Konkurs Na Dyrektora'),
(8, 'Maszyna Z Ruchomymi Częściami W Osłonach'),
(9, 'Maszyna Z Ruchomymi Częściami Bez Osłon'),
(10, 'Mikroklimat Gorący'),
(11, 'Mikroklimat Zmienny'),
(12, 'Mikroklimat Zimny'),
(13, 'Monitor Poniżej, Powyżej, Równo 4H'),
(14, 'Narażenie Życia, Stres, Decyzyjność'),
(15, 'Nitro (Rozpuszczalniki),'),
(16, 'Odpowiedzialność Finansowa'),
(17, 'Praca Fizyczna (Dźwiganie Ciężarów), - Lekka'),
(18, 'Praca Fizyczna (Dźwiganie Ciężarów), - Średnio Ciężka / Ciężka / Bez Określenia Jaka'),
(19, 'Praca Na Wysokości Do 3M'),
(20, 'Praca Na Wysokości Powyżej 3M'),
(21, 'Praca Stresogenna (Stres, Stały Dopływ Informacji, Decyzyjność),'),
(22, 'Praca Z Narzędziami Ręcznymi'),
(23, 'Prąd'),
(24, 'Propan'),
(25, 'Spawanie Gazowe'),
(26, 'Stanowisko Decyzyjne'),
(27, 'Wózek Widłowy, Unoszący, Drogowy, Jezdniowy Powyżej 1,6M'),
(28, 'Wózek Elektryczny'),
(29, 'Wysokość Poniżej 3M'),
(30, 'Wysokość Powyżej 3M'),
(31, 'Zagrożenie Wynikające Ze Stałego Dużego Dopływu Informacji I Gotowość Do Odpowiedzi')
